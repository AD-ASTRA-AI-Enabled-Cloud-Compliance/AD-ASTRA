...
# This module defines the LLMMapper class for interacting with OpenAI GPT-4 to generate and validate cloud security context.
# - Loads environment variables and sets up OpenAI GPT-4 as the LLM.
# - Provides token counting for prompt size estimation.
# - Implements a method to call OpenAI’s chat completion API with system and user prompts, handling token limits and errors.
# - Includes logic (commented out) for calling Ollama/Gemma locally.
