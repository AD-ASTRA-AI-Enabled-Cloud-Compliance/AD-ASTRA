          ...
          <Hero
            ...
            description={
              <FallInPlace delay={0.4} fontWeight="medium">
                <Em>SkyLock </Em>
                 is a tool design with security in mind for startups.
    ...
    <Highlights>
      <HighlightsItem colSpan={[1, null, 2]} title="Core Functions">
        <VStack alignItems="flex-start" spacing="8">
          <Text color="muted" fontSize="xl">
            Cloud compliant deployments compatible with international frameworks,
            i.e.: HIPAA, GDPR, ISO-27001, among others.
            <Br />
            Automated validation & Remediation: You choose what you need to deploy.
            <Br />
          </Text>
      ...
      <HighlightsItem title="Security in mind">
        <Text color="muted" fontSize="lg">
          We help your business minimize the risk of data exfiltration and regulator
          sanctions by verifying your infrastructure's architecture.
        </Text>
      </HighlightsItem>
      ...
      >
        <Text color="muted" fontSize="lg">
          We took care of all your basic compliance verification needs, 
